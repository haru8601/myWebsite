...
// try {
// File fishFile = new File(pathProperty.getStaticResources() +
// "/json/words/fish.json");
// File vegetablesFile = new File(pathProperty.getStaticResources() +
// "/json/words/vegetables.json");
...
// }
// BufferedReader fishBr = Files.newBufferedReader(fishFile.toPath(),
// Charset.forName("UTF-8"));
// WordsDto fishJson = mapper.readValue(fishBr, WordsDto.class);
// BufferedReader vegetablesBr =
// Files.newBufferedReader(vegetablesFile.toPath(), Charset.forName("UTF-8"));
// WordsDto vegetablesJson = mapper.readValue(vegetablesBr, WordsDto.class);
// mav.addObject("words",
// Stream.concat(fishJson.getNames().stream(),
// vegetablesJson.getNames().stream()).collect(Collectors.toList()));
// } catch (IOException e) {
